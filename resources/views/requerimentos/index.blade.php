...
<header class="container-fluid bg-gradient-to-b from-light py-4 position-relative" style="background: linear-gradient(to bottom, #f7f9fc, #f3f5f9);">
    <div class="container d-flex justify-content-between align-items-center position-relative">
        ...
        <a href="{{ route('requerimentos.create') }}" class="btn btn-sm btn-primary"> Solicitar um novo requerimento </a>
    </div>
</header>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="text-center">
                            <a href="{{ route('requerimentos.show', ['requerimento' => $requerimento->id]) }}"
